...
const createCardSpec = (position: Vec3, rotation: EulerTuple): CardSpec => ({ position, rotation });

const CARD_SPECS: CardSpec[] = [
  createCardSpec([0, 0, 0], [0.05, -0.2, 0.02]),
  createCardSpec([0.12, 0.08, -0.08], [0.08, -0.12, -0.03]),
  createCardSpec([-0.1, -0.06, -0.16], [0.02, -0.05, 0.04]),
  createCardSpec([0.06, -0.14, -0.24], [0.06, 0.05, -0.02]),
  createCardSpec([-0.08, 0.16, -0.32], [-0.02, 0.1, 0.01])
];
